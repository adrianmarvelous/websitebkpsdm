        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <a class="btn btn-success" href="{{ Route::has('dashboard.info-penting.add') ? route('dashboard.info-penting.add') : '#' }}">
...
$(document).ready( function () {
    $('#tabel').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('dashboard.info-penting.datatable') }}',
            method: 'POST'
        },
        columns: [
...
function hapus_data(id){
    ...
    swal.fire({
        ...
        if(e.value){
            $.ajax({
                url:'{{route('dashboard.info-penting.hapus')}}',
                method:'post',
                dataType: 'json',
