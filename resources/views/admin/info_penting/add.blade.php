            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="horizontal-form-preview">
                        <form id="form" class="form-horizontal" method="post" action="{{route('dashboard.info-penting.save')}}">

                        <div class="alert alert-info">* Lampiran dapat di-upload setelah formulir ini dilengkapi</div>


                            <div class="form-group row mb-3">
                                <label for="judul" class="col-md-3 col-form-label">Judul Info</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group mb-0 justify-content-end row">
                                <div class="col-md-9">
                                    ...
                                    <a class="btn btn-light" href="{{route('dashboard.info-penting')}}"><i class="uil-backward"></i> Kembali</a>
                                </div>
                            </div>
                        </form>
                        <p></p>
...
$(document).ready(function(){
    $("#submitform").click(function(){
        ...
        $.ajax({
            url:"{{ route("dashboard.info-penting.save") }}",
            method:"POST",
