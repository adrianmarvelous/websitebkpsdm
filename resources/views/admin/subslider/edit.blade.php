            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="horizontal-form-preview">
                        <form id="form" class="form-horizontal" method="post" action="{{route('dashboard.subslider.update')}}">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <span class="text-danger">Foto disarankan memiliki resolusi panjang: 660 x tinggi: 620 (pixel)</span>
                                </div>
                            </div>
                            @if($old_data->foto)
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group mb-0 justify-content-end row">
                                <div class="col-md-9">
                                    ...
                                    <a class="btn btn-light" href="{{route('dashboard.subslider')}}"><i class="uil-backward"></i> Kembali</a>
                                </div>
                            </div>
                        </form>
                        <p></p>
...
$(document).ready(function(){
    $("#submitform").click(function(){
        ...
        $.ajax({
            url:"{{ route("dashboard.subslider.update") }}",
            method:"POST",
