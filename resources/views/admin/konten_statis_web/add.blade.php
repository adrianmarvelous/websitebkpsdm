            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="horizontal-form-preview">
                        <form id="form" class="form-horizontal" method="post" action="{{route('dashboard.konten-statis-web.save')}}">

                        <div class="alert alert-info">* Lampiran dapat di-upload setelah formulir ini dilengkapi</div>


                            <div class="form-group row mb-3">
                                <label for="judul" class="col-md-3 col-form-label">Judul Halaman</label>
                                <div class="col-md-9">
                                    <input type="text" autocomplete="off" class="form-control" id="judul_konten" name="judul_konten">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <textarea id="narasi" name="narasi" class="summernote-basic"></textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="parent" id="parent">
                                        ...
                                        @foreach($parents as $parent)
                                            <option value="{{$parent->id}}">{{$parent->judul_konten}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
$(document).ready(function(){
    $("#submitform").click(function(){
        ...
        $.ajax({
            url:"{{ route("dashboard.konten-statis-web.save") }}",
            method:"POST",
