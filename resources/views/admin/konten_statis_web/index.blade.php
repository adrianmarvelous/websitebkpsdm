        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <a class="btn btn-success" href="{{ Route::has('dashboard.konten-statis-web.add') ? route('dashboard.konten-statis-web.add') : '#' }}">
...
$(document).ready( function () {
    $('#tabel').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('dashboard.konten-statis-web.datatable') }}',
            method: 'POST'
        },
        columns: [
...
function hapus_data(id){
    ...
    swal.fire({
        ...
        if(e.value){
            $.ajax({
                url:'{{route('dashboard.konten-statis-web.hapus')}}',
                method:'post',
                dataType: 'json',
