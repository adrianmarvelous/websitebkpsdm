            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="horizontal-form-preview">
                        <form id="form" class="form-horizontal" method="post" action="{{route('dashboard.user.update')}}">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="text" autocomplete="off" value="{{sanitizeString($old_data->name)}}" class="form-control" id="name" name="name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-5">
                                    <input type="text" autocomplete="off" value="{{sanitizeString($old_data->username)}}" class="form-control" id="username" name="username">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                <label for="role" class="col-md-3 col-form-label">Hak Akses</label>
                                <div class="col-md-3">
                                    <select class="form-control" name="role" id="role">
                                        <option value="">Pilih</option>
                                        @foreach($role as $parent)
                                            @if ($parent->role != 'Developer' && $parent->role != 'Content Manager' )
                                            <option {{($parent->id == $old_data->role) ? 'selected' : ''}} value="{{$parent->id}}">{{sanitizeString($parent->role)}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group mb-0 justify-content-end row">
                                <div class="col-md-9">
                                    ...
                                    <a class="btn btn-light" href="{{route('dashboard.user')}}"><i class="uil-backward"></i> Kembali</a>
                                </div>
                            </div>
                        </form>
                        <p></p>
