        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <a class="btn btn-success" href="{{ Route::has('dashboard.berita.add') ? route('dashboard.berita.add') : '#' }}">
...
$(document).ready( function () {
    $('#tabel').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('dashboard.berita.datatable') }}',
            method: 'POST'
        },
        columns: [
...
function hapus_data(id){
    ...
    swal.fire({
        ...
        if(e.value){
            $.ajax({
                url:'{{route('dashboard.berita.hapus')}}',
                method:'post',
                dataType: 'json',
