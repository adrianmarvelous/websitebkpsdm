                ...
                <!-- List group -->
                    ...
                    <div class="mr-auto">
                      ...
                      <ul class="breadcrumb">
                        ...
                        <li><a href="/artikel/{{$kategori}}" style="text-transform:uppercase">{{$kategori}}</a></li>
                      </ul>


                      <h2 class="font-weight-bold mb-1">
                        {{$item->judul ?? 'Judul belum ada'}}
                      </h2>
                      ...
                      <p class="text-danger">
                        ...
                        {{tanggal_hari('D, j M Y',$item->tanggal)}}</p>


                      <!-- Text -->
                      <p style="text-align: justify;" class="font-size-sm mb-0 mt-4">
                        {!!$item->deskripsi ?? 'Konten untuk halaman ini belum tersedia'!!}
                      </p>



                        <div class="alert alert-warning" style="display: block"> <a target="_blank" href="{{asset('assets/artikel/'.$item->file)}}" target="_blank">
                          [File PDF]</a>
                        </div>
