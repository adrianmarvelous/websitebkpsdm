...
if(htmlentities(isset($_POST["rating_data"])))
{
	if (htmlentities($_POST["rating_data"]) == 1 || htmlentities($_POST["rating_data"]) == 2 || htmlentities($_POST["rating_data"]) == 3){
		$rating_data = 4;
	}
	else{
		$rating_data = htmlentities($_POST["rating_data"]);
	}

	$data = array(
		':kode_booking'		=>	htmlentities($_POST["kode_booking"]),
	...
	echo "Berhasil Menambahkan Rating";
